...
namespace IIS.Test
{
    ...
    public class Запись : ICSSoft.STORMNET.DataObject
    {
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Test.Клиент Клиент
        {
            get
            {
                ...
                IIS.Test.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьE", typeof(IIS.Test.Запись));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаписьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьL", typeof(IIS.Test.Запись));
                }
            }
        }
    }
