...
CREATE INDEX Index1dc3b24c817a0a523cd77286bc23d0b7625c5ac7 on Запись (Клиент); 
 ...
 ALTER TABLE Услуга ADD CONSTRAINT FKd6ad69d39a9eadbca717b963bd2d5252ee76bf3d FOREIGN KEY (Запись) REFERENCES Запись; 
CREATE INDEX Indexd6ad69d39a9eadbca717b963bd2d5252ee76bf3d on Услуга (Запись); 
